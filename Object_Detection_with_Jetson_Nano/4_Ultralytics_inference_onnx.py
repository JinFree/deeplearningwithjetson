...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Ultralytics YOLO ONNX + OpenCV Inference Script")
    parser.add_argument("--model", type=str, required=True, help="onnx 파일 경로")
