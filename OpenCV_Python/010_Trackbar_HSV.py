...
def main() :
    ...
    cv2.createTrackbar("V", "Image", 128, 255, nothing) # 초기값 -> 128 / 최대값 -> 255
    ...
    while True :
        ...
        v = cv2.getTrackbarPos("V", "Image") # Trackbar 명칭 / Trackbar가 등록된 Named Window
        
        # Generate New Image
        image[:] = [h, s, v]
        
        # Color Space Conversion (HSV -> BGR)
        image = convertColor(image, cv2.COLOR_HSV2BGR)
