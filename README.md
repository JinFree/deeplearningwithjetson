...
- [NVIDIA Developer Program ](https://developer.nvidia.com/)계정(◀클릭)이 없는 경우 교육 시작 전 미리 가입해 주시기 바랍니다. (필수)
  ...
  - 참고 : 교육 자료는 교육 당일 별도 안내를 통해 확인하실 수 있습니다. (교육 참석자에 한해 제공)
  - 복습은 교육이 끝난 후 https://learn.nvidia.com/my-learning 에서 6개월 동안 제공됩니다.

- [이 링크](http://websocketstest.courses.nvidia.com/)를 클릭하신 후 세 가지 테스트 단계가 모두 "예"로 선택되어 있는지 확인합니다.  
